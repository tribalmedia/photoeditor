var photoEditor = {
    ...
    init: function(param) {
        ...
        document.getElementById("pe-contrast").onclick = this.changeImageFilter.bind(this, 'contrast');
        document.getElementById("pe-brightness").onclick = this.changeImageFilter.bind(this, 'brightness');
        document.getElementById("pe-grayscale").onclick = this.changeImageFilter.bind(this, 'grayscale');
        document.getElementById("pe-blur").onclick = this.changeImageFilter.bind(this, 'blur');
        document.getElementById("pe-saturate").onclick = this.changeImageFilter.bind(this, 'saturate');
