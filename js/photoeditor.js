var photoEditor = {
    ...
    initCanvas: function(urlImg, nameTag) {
        ...
        this.image.onload = function() {
            ...
            document.getElementById('pe-panel').style = "border: 1px solid white";
